...
<img src="/images/IMG_7931.jpg" alt="Thuong Hoang" width="15%" style="float: left">
Currently (2023), I am a postdoc at BICEP/Keck group at University of Minnesota, USA. 
I obtained Ph.D in Physics of the Universe from AstroParticle and Cosmology (APC) laboratory, University of Paris, France, in 2018. After completing PhD, I did postdoctoral research at Cornell University, Kavli IPMU-University of Tokyo, Japan.
...
Most of my work focuses on CMB polarization measurements to constran inflationary models of the Universe, including data analysis, simulation and instrumentation using superconducting `Transition Edge Sensor (TES)` detectors, half-wave plate system for CMB experiments. <br>

In addition, I investigate `magnetic fields` in molecular clouds to study the evolution and formation of stars. <br>

I have received training across multiple international institutions (France, the United States, Japan, and Vietnam) and have experience working on both satellite missions (LiteBIRD) and ground-based CMB experiments such as BICEP, Simons Observatory, QUBIC, and CMB-S4. 
I have contributed to the flagship BICEP experiment in data processing to constrain the amplitude of primordial gravitational waves generated by cosmic inflation. I also have teaching experience.
